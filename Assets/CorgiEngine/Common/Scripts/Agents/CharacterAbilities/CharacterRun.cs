...
namespace MoreMountains.CorgiEngine
{
    ...
    public class CharacterRun : CharacterAbility
    {
        ...
        public override string HelpBoxText() { return "这个组件允许你的角色在按下运行按钮时改变速度(定义在这里)。"; }
        ...
        protected override void InitializeAnimatorParameters()
        {
            ...
            RegisterAnimatorParameter(_moveingAnimationParameterName, AnimatorControllerParameterType.Bool, out _moveingAnimationParameter);
        }
        ...
        public override void UpdateAnimator()
        {
            ...
            MMAnimatorExtensions.UpdateAnimatorBool(_animator, _moveingAnimationParameter, (_movement.CurrentState == CharacterStates.MovementStates.Running || _movement.CurrentState == CharacterStates.MovementStates.Walking), _character._animatorParameters, _character.PerformAnimatorSanityChecks);
        }
