...
namespace MoreMountains.CorgiEngine
{
    ...
    {
        public override string HelpBoxText() { return "这个类允许您使用grabcarriandthrowobject组件抓取、携带和投掷对象。" +
                "在抓取部分，你可以定义你想要的光线投射来检测可抓取的对象如何工作，在携带部分，你可以设置一个可选的子变换来附加携带的对象，" +
                "在投掷部分，你可以定义你想要“这个角色的投掷有多强，以及它应该得到多少反冲。"; }
