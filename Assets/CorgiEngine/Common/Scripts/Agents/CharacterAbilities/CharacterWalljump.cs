...
namespace MoreMountains.CorgiEngine
{
	...
	public class CharacterWalljump : CharacterAbility 
	{
		...
		public override string HelpBoxText() { return "这个组件允许你的角色在紧贴墙壁时执行额外的跳跃。在这里你可以确定作用于跳跃的力。"; }
		...
		[Tooltip("如果这是正确的，墙体跳跃就算作常规跳跃，以减少剩余的跳跃次数")]
		...
		[Tooltip("如果这是真的，角色将被迫朝跳跃帧的跳跃方向翻转")]
