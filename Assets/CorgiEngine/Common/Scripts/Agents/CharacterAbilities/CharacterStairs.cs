...
namespace MoreMountains.CorgiEngine
{
    ...
    public class CharacterStairs : CharacterAbility
    {
        ...
        [Tooltip("持续时间(以秒为单位)，在开始走下楼梯时，与单向平台的碰撞应该被忽略")]
