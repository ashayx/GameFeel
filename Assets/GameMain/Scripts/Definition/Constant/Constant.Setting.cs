...
namespace Game
{
    public static partial class Constant
    {
        public static class Setting
        {
            ...
            public const string MaxScore = "Setting.MaxScore";
        }

        public static class Config
        {
            public const string Hero = "Hero";
            public const string KillExp = "KillExp";
            public const string FlowerExp = "FlowerExp";
            public const string MonsterExp = "MonsterExp";
        }
    }
