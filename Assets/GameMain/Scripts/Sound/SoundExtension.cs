...
namespace Game
{
    public static class SoundExtension
    {
        ...
        public static int? PlayMusic(this SoundComponent soundComponent, EnumMusic musicId)
        {
            return soundComponent.PlayMusic((int)musicId);
        }
        ...
        public static int? PlaySound(this SoundComponent soundComponent, EnumSound soundId, EntityLogic bindingEntity = null, object userData = null)
        {
            return soundComponent.PlaySound((int)soundId);
        }
