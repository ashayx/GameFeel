...
namespace ZeroEditor
{
    ...
    public class BitmapFontCreaterMenu
    {
        ...
        /// 文件名
        /// </summary>
        [MenuItem("Tools/Bitmap/Create Bitmap Font (Direct)/Use「PNG File Name」", false, 0)]
        ...
        /// 直接用当前目录下的资源创建字体
        /// </summary>
        [MenuItem("Tools/Bitmap/Create Bitmap Font (Direct)/Use「chars.txt」", false, 0)]
        ...
        /// 直接
        /// </summary>
        [MenuItem("Tools/Bitmap/Create Bitmap Font (GUI)", false, 1)]
        ...
        [MenuItem("Tools/Bitmap/Create Bitmap Font", false, 1)]
